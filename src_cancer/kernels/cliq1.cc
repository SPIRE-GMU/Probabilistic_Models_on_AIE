...
void cliq1(input_stream<float> *  __restrict bufin0, output_stream<float>*  __restrict bufout0,input_stream<float> *  __restrict bufin1, output_stream<float>*  __restrict bufout1)
{
   ...
   float table[8] = {0.0081,0.2619,0.0015,0.0285,0.0006,0.6294,0.0014,0.0686};
    ...
    writeincr(bufout1,table[0]+table[1]+table[4]+table[5]); //c=1 
    writeincr(bufout1,table[2]+table[3]+table[6]+table[7]); //t=1 
    writeincr(bufout1,0);
    writeincr(bufout1,0);
